...
- 게임 모드(= 미니게임 하나, 2026-09-25 R19): **킹 러시**(장애물 달리기와 팀 배틀 구간이 3번 교차), **퀸 오브 더 힐**(성을 올라 정상의 폰이 퀸으로 승격, 다음 개발), **소드 파이트**(물리 칼 팀 데스매치). 더 늘 수 있다. 모드마다 따로 매칭한다. 상세: [GameModes](../GameModes/README.md).
